...
function KrystoVsG1() {
  return (
    <section>
      ...
      <p>
        Les formules mathématiques (algorythmes) utilisée par le système Krysto
        ne sont pas tout a fait similaires à celle de la Ğ1.
      </p>
      <h2 className="title-section">Formule du dividende en Krysto</h2>
      <p className="formule">
        {' '}
        <span>1 Krysto =</span> (masse monétaire / nombre d'utilisateurs /
        365.25) * 12
      </p>
      ...
      <p className="big-paragraphe">
        Sur krysto l'unicité des comptes est garantie d'une autre façon :{' '}
      </p>
      <p>
        {' '}
        via le paiement des abonnements. En effet, il n'est pas possible de
        créer plusieurs compte Krysto avec la même identité banquaire (carte
        bleue).
      </p>
      <p>
      ...
      <ul className="comparatif-list">
        <li>
          {' '}
          <FaCheck /> Plafonemend des comptes de dépôts{' '}
        </li>
        <li>
          {' '}
          <FaCheck />
        ...
        <li>
          {' '}
          <FaCheck />
          Imposibilité de spéculer sur le valeur du Krysto
        </li>
      </ul>
      <p>
        ...
        beaucoup de Krysto, la seule chose qu'elle peut en faire est de les
        dépenser en achetant des annonces sur la plateforme Krysto, ce qui
      ...
      <p>
        ...
        indicatif afin de faciliter la compréhension et la prise en main de
        cette nouvelle forme de monnaie, par le plus grand nombre.{' '}
      </p>{' '}
      <div className="formule"> (1 Krysto ~ 1000 XPF)</div>
      <p className='big-paragraphe'>
      ...
      <p>
        ...
        fixé à 365.25 Krysto, soit 365 250 XPF, permet d'accumuler une quantité de
      ...
      <p className="big-paragraphe">
        400 XPF par mois vous donne potentiellement accès à 30 000 XPF de
        pouvoir d'achat mensuel en Krysto, en pouvant cumuler grâce a votre
        compte de dépot j'usqu'a 300 000 XPF !
      </p>
