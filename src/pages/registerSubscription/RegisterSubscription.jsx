  ...
  return (
    <section>
      ...
      <h3 className='freenium'>Inscription gratuite pour les 1000 premmiers utilisateur</h3>
        <p className='big-paragraphe'>Pour accéder à tous les services Krysto et recevoir vos Krysto tous les jours, inscrivez-vous en choisissant parmis les formules suivantes :</p>
