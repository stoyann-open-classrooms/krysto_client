  ...
  return (
    <div className="page-content">
     <HeroTitle title={"Une monnaie complémentaire local et solidaire pour vous faire gagner du pouvoir d'achat."}/>
      ...
      <h4 className="">  <FaQuestionCircle/> Une monnaie libre c'est quoi ?</h4>
      ...
      <h4> <FaCoins/> Une monnaie différente...</h4>
      <p>
      ...
      <h4> <FaConfluence/> Une monnaie relative</h4>
      <p>
      ...
      <h4 > <FaBitbucket/> La monnaie n'est pas le fruit du travail.</h4>
      <p>
      ...
      <h4 > <FaMoneyCheckAlt/> Mais alors qui produit la monnaie ?</h4>
      <p>
      ...
      <h4> <FaCoins/> Et la monnaie libre ?</h4>
      <p >
