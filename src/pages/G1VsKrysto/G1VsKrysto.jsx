...
function G1VsKrysto() {
  return (
    <main>
      ...
      <HeroTitle
        title={'G1 VS Krysto: comparatif'}
        subtitle={
          'La ressemblance entre les deux monnaies étant évidentes pour ceux qui connaissent la Ğ1, ce comparatif vous aidera à mieux comprendre leurs différences.'
        }
      />
